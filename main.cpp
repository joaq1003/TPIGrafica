...
// colores
static float color_segs_int[]  = { 0.6f, 0.1f, 0.6f, 0.6f };
...
//void main_keyboard(GLFWwindow* window, int key, int scancode, int action, int mods) {
//    if (action == GLFW_PRESS) {
//        // Este código se ejecuta cuando se presiona una tecla
//        switch (key) {
//        case GLFW_KEY_ESCAPE:
//            glfwSetWindowShouldClose(window, GLFW_TRUE); // Cierra la ventana cuando se presiona la tecla ESC
//            break;
//            //A partir de aca son los callback para empezar a modificar las curvas
//        }
//    } 
//}
